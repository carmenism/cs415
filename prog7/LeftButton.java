/**
 * LeftButton.java
 *    This creates a button to move a buggy to the left with the increment
 *    from the slider.
 *    Methods:
...
public class LeftButton extends DrawButton
{
   ...
   /**
    * LeftButton( int x, int y, Buggy b, Slider s )
    ...
    * s: saves a slider
    */
   public LeftButton( int x, int y, Buggy b, Slider s )
   {
      super( x, y, b, s );
   ...
   /**
    * mousePressed
    *    Sets the color of the button to red and moves the buggy  to the left
