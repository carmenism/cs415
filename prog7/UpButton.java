/**
 * UpButton.java
 *    This creates a button to move a buggy upward with the increment
 *    from the slider.
 *    Methods:
...
public class UpButton extends DrawButton
{
   ...
   /**
    * UpButton( int x, int y, Buggy b, Slider s )
    ...
    * s: saves a slider
    */
   public UpButton( int x, int y, Buggy b, Slider s )
   {
      super( x, y, b, s );
   ...
   /**
    * mousePressed
    *    Sets the color of the button to red and moves the buggy upward using
