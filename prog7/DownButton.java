/**
 * DownButton.java
 *    This creates a button to move a buggy downward with the increment
 *    from the slider.
 *    Methods:
...
public class DownButton extends DrawButton
{
   ...
   /**
    * DownButton( int x, int y, Buggy b, Slider s )
    ...
    * s: saves a slider
    */
   public DownButton( int x, int y, Buggy b, Slider s )
   {
      super( x, y, b, s );
   ...
   /**
    * mousePressed
    *    Sets the color of the button to red and moves the buggy downward
   ...
   public void mousePressed( MouseEvent e )
   {
      ...
      nextPoint = new Point( currentPoint.x,
                             currentPoint.y + increment );
