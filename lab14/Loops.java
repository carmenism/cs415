...
{  
   ...
   private static int getInt( String arg, int defaultVal )
   {
      ...
      {  
         cmdErrors++;
         System.err.println( "***Error while parsing command line parameter: " + arg );
         System.err.println( "    Should be an integer. Using default value: " + defaultVal );
      }
   ...
   public static void printArray( String header, int[] values )
   {
      ...
      {
         if ( i % numbersPerLine  == 0 )    // only print a limited on each line
            System.out.println();
